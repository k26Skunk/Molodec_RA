...
$sub='Заказ макета'; //сабж
$email='no-reply@gmail.com'; // от кого
...
?>
    ...
    <head>
        ...
        <title>Вы отправили заявку на макет, спасибо! С Вами скоро свяжутся.</title>
        <meta name="generator" />
        <style type="text/css">
            body {
                background: #c64444;
    ...
    <body>
        ...
        <h1 style="text-align:center;margin:30vh auto;color:#fff;font-weight:normal">Вы отправили заявку на макет, спасибо!<br>С Вами скоро свяжутся.</h1>
